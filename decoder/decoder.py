...
class Decoder(nn.Module):
    def __init__(self, out_channels=64):
        ...
        self.de_conv1 = nn.Sequential(
            ...
            WTConv2d(channels[1], channels[1], 3),
            WTConv2d(channels[1], channels[1], 3),
        ...
        self.de_conv2 = nn.Sequential(
            ...
            WTConv2d(channels[2], channels[2], 3),
            WTConv2d(channels[2], channels[2], 3),
        ...
        self.de_conv3 = nn.Sequential(
            ...
            WTConv2d(channels[3], channels[3], 3),
            WTConv2d(channels[3], channels[3], 3),
        ...
        self.de_conv4 = nn.Sequential(
            nn.ConvTranspose2d(channels[3], channels[4], kernel_size=4, stride=2, padding=1),
            WTConv2d(channels[4], channels[4], 3),
            WTConv2d(channels[4], channels[4], 3),
    ...
    def forward(self, x1, x2, x3, x4):
        x1 = self.de_conv1(x1)
        x2 = self.de_conv2(x2 + x1)
        x3 = self.de_conv3(x3 + x2)
        x4 = self.de_conv4(x4 + x3)
        return self.last(x4)
