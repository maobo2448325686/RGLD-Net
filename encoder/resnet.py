...
from encoder.SSA import Sparse_Self_Attention
...
class BSM(nn.Module):
    ...
    def __init__(self, in_channels, out_channels):
        ...
        self.conv3 = nn.Conv2d(self.in_channels, self.out_channels, 3, padding=1, bias=True)
        self.conv1 = nn.Conv2d(self.in_channels, self.out_channels, 1)
        self.ssa = Sparse_Self_Attention(self.in_channels, num_heads=8, sparse_size=8)
